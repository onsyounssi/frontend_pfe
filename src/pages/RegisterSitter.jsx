...
const RegisterSitter = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const hasDispo = Object.values(formData.disponibilites).some(v => v === true);
    ...
    if (
      ...
      !formData.langues.trim()
    ) {
      setError("Veuillez remplir tous les champs du formulaire pour créer un profil complet.");
      setSubmitting(false);
      return;
    }
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-3 pt-2 flex-wrap sm:flex-nowrap">
              ...
              <button
                ...
                className={`flex-[2] py-3 rounded-xl font-semibold text-white text-sm shadow-lg transition flex items-center justify-center gap-2 w-full sm:w-auto ${submitting ? 'bg-indigo-300 cursor-not-allowed' : 'bg-indigo-600 hover:bg-indigo-700 active:scale-[0.99]'
                  }`}
              >
                <Save size={16} />
