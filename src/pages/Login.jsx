...
function Login() {
  ...
  const handleSubmit = async (e) => { 
    ...
    else if (user.role === "sitter") navigate("/sitter");
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div className="p-10">
              ...
              <form onSubmit={handleSubmit} className="mt-8 space-y-5">
                ...
                <button 
                  type="submit"
                  className="w-full py-3.5 rounded-2xl font-semibold text-white shadow-lg transition bg-pink-600 hover:bg-pink-700"
                >
                  Se connecter
                </button>
                ...
                <div className="flex items-center justify-between text-sm text-gray-600">
                  ...
                  <button
                    type="button"
                    onClick={(e) => sethandleForgotPassword(e.target.viewBox)}
                ...
                <div className="rounded-2xl border border-gray-100 bg-gray-50 p-4 text-sm text-gray-700">
                  ...
                  <p className="text-gray-600 mt-2">
                    Utilisez les identifiants démo pour tester les rôles parents/sitters.
                  </p>
                </div>
              </form>
            </div>
